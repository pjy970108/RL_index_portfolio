...
def main_wandb():
    ...
    # 경로 없으면 경로 생성하는 코드
    # 6. 모델 저장 경로 설정
    model_path = f'./portfolio_price_discrete_rebal_step_1m_concat_asset/model/{traj_len}_seed_v4/'
...
if __name__ == "__main__":
    sweep_id = wandb.sweep(sweep_config, project="grpo_portfolio_rebal_seed_v1")
