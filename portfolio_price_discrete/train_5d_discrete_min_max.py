...
def main_wandb():
    ...
    # 1. config 파일 로드
    with open("./grpo_notarn_discrete/config/train_config.yaml", "r") as f:
    ...
    # 경로 없으면 경로 생성하는 코드
    # 6. 모델 저장 경로 설정
    model_path = f'./grpo_notarn_discrete/model/{traj_len}_minmax/'
...
if __name__ == "__main__":
    set_seed(42)
    sweep_id = wandb.sweep(sweep_config, project="grppo_index_5d_notarn_discrete_minmax")
