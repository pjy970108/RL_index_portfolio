...
def main_wandb():
    ...
    # 경로 없으면 경로 생성하는 코드
    # 6. 모델 저장 경로 설정
    model_path = f'./grpo_notarn_discrete/model/{config["batch_samples"]}_{traj_len}/'
...
if __name__ == "__main__":
    set_seed(42)
    sweep_id = wandb.sweep(sweep_config, project="grppo_index_3m_notarn_discrete")
