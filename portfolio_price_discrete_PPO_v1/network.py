...
class ActorCritic(nn.Module):
    ...
    def __init__(self, feature, action_dim, has_continuous_action_space, action_std_init, device):
        ...
        self.feature_dim = feature * action_dim
    ...
    def act(self, state, deterministic=False):
        ...
        if self.has_continuous_action_space:
            ...
            if deterministic:
                ...
                return action.detach(), None, self.critic(state).detach()
